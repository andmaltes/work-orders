...
**6-8 hour timebox:** If you run out of time, no worries! Just add `@upgrade` comments on incomplete parts explaining what you'd build next. We want to see how you think and prioritize.
...
**Q: What if I don't finish in the timebox?**
